...
public interface FreecellOperations<K> {
   ...
   * has one or more of these flaws: <ul> <li>It does not have 52 cards</li> <li>It has duplicate
   * cards</li> <li>It has at least one invalid card (invalid suit or invalid number) </li> </ul>
   *
